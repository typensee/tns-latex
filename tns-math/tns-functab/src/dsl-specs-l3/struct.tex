...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Un nouveau contexte s'indique en début de contenu via \tdoclatexin{nom_contexte = contenu_1 ; ...} sans nécessité répéter à la suite le même nom de contexte.

        \item \textbf{Aucun contexte par défaut n'est initialement défini.}
    \end{itemize}


    \item Pas de point-virgule à la fin du tout dernier contenu.
\end{enumerate}
