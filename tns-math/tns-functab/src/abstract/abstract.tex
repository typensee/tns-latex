...
\noindent
Le paquet \thispack\ fournit des moyens intuitifs et efficaces pour taper de petits tableaux de données, ainsi que des tableaux de signes et de variations de fonctions mathématiques.
