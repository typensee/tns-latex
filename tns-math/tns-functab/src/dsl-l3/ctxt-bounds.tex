...
\subsubsection{Le contexte \tdocinlatex{bounds}}
\label{tns-math-functab-ctxt-bounds}

Pour indiquer les valeurs initiales nécessaires à la conception d'un tableau, il faut passer via le contexte \tdocinlatex{bounds} en respectant les règles ci-après.
\begin{enumerate}
