...
Le contexte \tdocinlatex{mat} qui n'est utilisable qu'une seule fois, permet de donner la matrice des données de façon \tdocquote{plate}\,, et ceci en indiquant, si besoin uniquement
\footnote{
	Ceci permet de taper un simple tableau à double entrée.
},
l'expression étudiée.
\textbf{Bien retenir que la matrice fournie est \tdocquote{plate}\,.}
