...
\begin{enumerate}
    ...
    \item \textbf{Des cases consécutives vides facilement :} la valeur particulière \tdocinlatex{..i} permet d'avoir $i$ cases vides consécutives. On peut employer \tdocinlatex{..} comme raccourci de \tdocinlatex{..1}\,.
\end{enumerate}
