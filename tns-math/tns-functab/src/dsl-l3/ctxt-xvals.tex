...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \tdocinlatex{x1 , x2 , ... , xn} indique que $n$ valeurs \tdocinlatex{x1} , \tdocinlatex{x2} , \dots\ , \tdocinlatex{xn} ont été données pour la variable nommée $x$ par défaut.
        
        \item On peut utiliser des valeurs \enquote{vides}\,.
    \end{itemize}


    \item \textbf{Des cases consécutives vides facilement :} la valeur particulière \tdocinlatex{..i} permet d'avoir $i$ cases vides consécutives où $i \geq 1$\,.
\end{enumerate}
