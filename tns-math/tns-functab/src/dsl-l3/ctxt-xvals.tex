...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \tdocinlatex{x1 , x2 , ... , xn} indique que $n$ valeurs pivots \tdocinlatex{x1} , \tdocinlatex{x2} , \dots\ , \tdocinlatex{xn} ont été données pour la variable nommée $x$ qui est le nom par défaut.
    \end{itemize}
\end{enumerate}
