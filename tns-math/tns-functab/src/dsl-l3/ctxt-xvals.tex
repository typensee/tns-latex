...
\begin{enumerate}
    ...
    %
    \begin{itemize}
        \item \tdocinlatex{ma_{var} : x_1 , x_2 , ... , x_n} indique que les $n$ valeurs \tdocinlatex{x_1} , \tdocinlatex{x_2} , \dots\ , \tdocinlatex{x_n} ont été données pour la variable nommée $ma_{var}$ avec $n \geq 1$\,.
