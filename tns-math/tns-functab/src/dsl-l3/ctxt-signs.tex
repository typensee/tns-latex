...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \tdocinlatex{f : u z}  indique que \verb#f# n'est pas définie sur \verb#]x_1 ; x_2[# et aussi que \verb#f = 0# sur \verb#]x_2 ; x_3[#
        \footnote{
        	Les lettres \tdocpre{u} et \tdocpre{z} sont pour
			\tdocprewhy{u.ndefined} et \tdocprewhy{z.ero}
			où
			\tdocquote{undefined} signifie \tdocinEN{non défini}.
		}.
    \end{itemize}
\end{enumerate}
