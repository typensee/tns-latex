...
.
        ...
        \item On peut aussi indiquer le comportement d'une expression en certaines valeurs pivots. Ceci se fait à côté d'une information de type signe : par exemple, en gardant les notations de l'item précédent, $f(x_3) = 0$ s'indiquera via \tdocinlatex{... 0 s_3 ...} si $n > 3$ , ou via \tdocinlatex{... s_3 0} si $n = 3$ .
