...
\begin{enumerate}
    ...
    \item Un seul contexte \tdocinlatex{signs} peut ne pas nommer l'expression qui sera $f$ par défaut, les autres devront le faire via \tdocinlatex{monexpr : ...} où les points de suspension spécifient les informations liées au comportement de l'expression (voir l'item suivant à ce sujet).
...
l'expression n'est pas définie au pivot concerné.
    	...
    	\item Il est possible de partiellement renseigner une ligne.
    \end{itemize}
\end{enumerate}
