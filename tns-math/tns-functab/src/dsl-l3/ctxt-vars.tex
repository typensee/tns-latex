...
\begin{enumerate}
    ...
    %
    \begin{itemize}
	    \item Un seul contexte \tdocinlatex{vars} peut ne pas nommer l'expression qui sera $f$ par défaut, les autres devront le faire via \tdocinlatex{monexpr : ...} où les points de suspension spécifient les informations liées au comportement de l'expression (voir ce qui suit).
