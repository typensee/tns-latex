...
%
\begin{enumerate}
    \item Voici les informations possibles pour le comportement d'une expression $f$ en supposant que $n$ valeurs pivots \tdocinlatex{x_1} , \tdocinlatex{x_2} , \dots\ , \tdocinlatex{x_n} ont été données via \tdocinlatex{bounds = x_1 , x_2 , ... , x_n} avec de nouveau $p = n - 1$ .
    %
    \begin{itemize}
        ...
        \begin{enumerate}
            ...
            \item \tdocinlatex{>} indique une expression une expression strictement décroissante sur l'intervalle concerné.
        ...
        \item On peut aussi indiquer les images de certaines valeurs pivots. Voici ce qui est disponible.
        %
        \begin{enumerate}
            ...
            \item Une valeur image devant contenir une lettre \tdocinlatex{u} et/ou la ponctuation \tdocinlatex{!} devra être protégée par des accolades. Ceci vient du fait que dans le langage codant les variations ces deux caractères ont une signification spéciale (voir ci-dessus et l'item suivant).
...
l'expression n'est pas définie au pivot concerné.
            ...
            \begin{itemize}
                ...
                \textbf{Cette syntaxe est interdite pour le premier pivot et le dernier.}
            \end{itemize}
        \end{enumerate}
    \end{itemize}
\end{enumerate}
...
\begin{multicols}{2}
    \tdoclatexinput[code]{examples/dsl/vars-always-defined.tex}

    \tdoclatexinput[code]{examples/dsl/vars-with-undefined.tex}
\end{multicols}
...
\begin{multicols}{2}
    \tdoclatexinput[code]{examples/dsl/vars-always-defined-monster.tex}

    \tdoclatexinput[code]{examples/dsl/vars-with-undefined-monster.tex}
\end{multicols}
