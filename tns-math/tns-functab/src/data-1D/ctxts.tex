...
%
\begin{enumerate}
	\item \tdoclatexin{xvals = x1 , x2 , ... , xk} indiquent les valeurs pour la variable $x$, qui est celle par défaut.

	\item \tdoclatexin{xvals = mavar : x1 , x2 , ... , xk} permet de renommer la variable en $mavar$.
\end{enumerate}
...
%
\begin{enumerate}
	\item \tdoclatexin{imgs = i1 , i2 , ... , ik} indiquent les images pour la fonction $f(x)$, qui est celle par défaut.

	\item \tdoclatexin{imgs = mafonc : i1 , i2 , ... , ik} indique les images pour la fonction $mafonc$.
\end{enumerate}
