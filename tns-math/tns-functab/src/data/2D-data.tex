...
\begin{tdocexa}[Avec des étiquettes de partout]
    En plus de \tdocinlatex{xvals} pour les colonnes, il faut utiliser \tdocinlatex{yvals} pour renseigner les valeurs des lignes.
    Quant aux valeurs des cellules, elles se donnent comme suit.
    %
    \begin{itemize}
    	\item Le contexte \tdocinlatex{mat} permet d'employer une écriture matricielle.
