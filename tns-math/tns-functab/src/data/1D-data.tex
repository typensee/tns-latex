...
%
\begin{enumerate}
	\item \tdocinlatex{xvals = x1 , x2 , ... , xn} indiquent les valeurs pour la variable nommée $x$ par défaut.

	\item \tdocinlatex{xvals = mavar : x1 , x2 , ... , xn} permet de renommer la variable en $mavar$\,.
\end{enumerate}


Une fois ceci fait, il faut renseigner les différentes images en donnant obligatoirement la formule de l'expression étudiée en passant via \tdocinlatex{imgs = monexpr : i1 , i2 , ... , in}\,.
